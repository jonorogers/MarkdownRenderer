...
namespace Unity.Markdown
{
    public class UIMarkdownRenderer : RendererBase
    {
        ...
        public static VisualElement GenerateVisualElement(string markdownText,  Action<string> LinkHandler, bool includeScrollview = true)
        {
            ...
            {
                s_DefaultStylesheet = Resources.Load<StyleSheet>("MarkdownRenderer");
                //AssetDatabase.LoadAssetAtPath("Packages/com.rtl.markdownrenderer/Styles/MarkdownRenderer.uss", typeof(StyleSheet)) as StyleSheet;
